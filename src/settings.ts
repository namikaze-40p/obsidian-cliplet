...
export class SettingTab extends PluginSettingTab {
	...
	constructor(private _app: App, private _plugin: Cliplet) {
		super(_app, _plugin);
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.setDesc('Select the storage location: IndexedDB (per device/vault, no auto-sync) or data.json (in your vault, syncs with backups).')
		...
		new Setting(containerEl)
			...
			.setDesc('Delete all data of "Cliplet". If you want to delete, type "Delete" in the text box and click the "Delete" button.')
			.addText(text => text
